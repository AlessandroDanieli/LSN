...
double Stat :: Average(double& average) const {
	auto t1 = chrono::high_resolution_clock::now();
	if (Nsample == 0) {
...
double Stat :: AverageSigma(double& average, double& sigma) const {
	auto t1 = chrono::high_resolution_clock::now();
	if (Nsample == 0) {
...
double Stat :: AverageVariance(double& average, double& variance) const {
	auto t1 = chrono::high_resolution_clock::now();
	if (Nsample == 0) {
...
double Stat :: BlockAverage(vector<double>& average) const {
	auto t1 = chrono::high_resolution_clock::now();
	if (Nsample == 0) {
...
double Stat :: BlockSigma(vector<double>& sigma) const {
	auto t1 = chrono::high_resolution_clock::now();
	if (Nsample == 0) {
...
// Quadratic deviation from block average, calculated for each block of data
double Stat :: BlockVariance(vector<double>& variance) const {
	auto t1 = chrono::high_resolution_clock::now();
	if (Nsample == 0) {
...
double Stat :: BlockAverageSigma(vector<double>& average, vector<double>& sigma) const {
	auto t1 = chrono::high_resolution_clock::now();
	if (Nsample == 0) {
...
double Stat :: BlockAverageVariance(vector<double>& average, vector<double>& variance) const {
	auto t1 = chrono::high_resolution_clock::now();
	if (Nsample == 0) {
...
double Stat :: BlockSigmaExp(vector<double>& sigma_exp) const {
	auto t1 = chrono::high_resolution_clock::now();
	if (Nsample == 0) {
...
double Stat :: BlockVarianceExp(vector<double>& variance_exp) const {
	auto t1 = chrono::high_resolution_clock::now();
	if (Nsample == 0) {
...
double Stat :: ProgAverageSigma(vector<double>& prog_average, vector<double>& prog_sigma) const {
	auto t1 = chrono::high_resolution_clock::now();
	if (Nsample == 0) {
...
double Stat :: BlockProgAverageSigma(vector<double>& prog_average, vector<double>& prog_sigma) const {
	auto t1 = chrono::high_resolution_clock::now();
	if (Nsample == 0) {
...
double Stat :: BlockProgAverageVariance(vector<double>& prog_average, vector<double>& prog_variance) const {
	auto t1 = chrono::high_resolution_clock::now();
	if (Nsample == 0) {
...
double Stat :: BlockProgSigmaSigma(vector<double>& prog_sigma, vector<double>& prog_error) const {
	auto t1 = chrono::high_resolution_clock::now();
	if (Nsample == 0) {
...
double Stat :: BlockProgVarianceSigma(vector<double>& prog_variance, vector<double>& prog_error) const {
	auto t1 = chrono::high_resolution_clock::now();
	if (Nsample == 0) {
...
double Stat :: BlockProgSigmaSigmaExp(vector<double>& prog_sigma, vector<double>& prog_error) const {
	auto t1 = chrono::high_resolution_clock::now();
	if (Nsample == 0) {
...
double Stat :: BlockProgVarianceSigmaExp(vector<double>& prog_variance, vector<double>& prog_error) const {
	auto t1 = chrono::high_resolution_clock::now();
	if (Nsample == 0) {
...
double Stat :: BlockProgAverageSigma(double& last_prog_average, double& last_prog_sigma) const {
	auto t1 = chrono::high_resolution_clock::now();
	if (Nsample == 0) {
...
double Stat :: BlockProgAverageVariance(double& last_prog_average, double& last_prog_variance) const {
	auto t1 = chrono::high_resolution_clock::now();
	if (Nsample == 0) {
...
double Stat :: BlockProgSigmaSigma(double& last_prog_sigma, double& last_prog_error) const {
	auto t1 = chrono::high_resolution_clock::now();
	if (Nsample == 0) {
...
double Stat :: BlockProgVarianceSigma(double& last_prog_variance, double& last_prog_error) const {
	auto t1 = chrono::high_resolution_clock::now();
	if (Nsample == 0) {
...
double Stat :: BlockProgSigmaSigmaExp(double& last_prog_sigma, double& last_prog_error) const {
	auto t1 = chrono::high_resolution_clock::now();
	if (Nsample == 0) {
		cerr << "Error [Stat :: BlockProgSigma(double&, double&)]: Nsample = 0" << endl;
		exit(-1);
